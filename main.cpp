...
string generate_random_string(const unsigned len)/*returns a random string of length len*/
...
unsigned generate_random_index(const unsigned max_ind) //*generate random number in range [0,max_ind-1]
